...
class NewsVideosViewController: BaseViewController {
    ...
    func loadNewsData(requestType: RequestType) {
        ...
        if flag == 2 {
            NetRequest.newsSearchNetRequest(title: keyword ?? "", categoryId: "4", page: "\(pageNumber)") { (success, info, result) in
                if success {
    ...
    lazy var photosTableView: WYPTableView = {
        ...
        photosTableView.register(VideoInfoTableViewCell.self, forCellReuseIdentifier: "videoCell")
...
extension NewsVideosViewController: UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        videoDetail.newsId = newsData[indexPath.row].newsId
        videoDetail.newsTitle = newsData[indexPath.row].infoTitle
