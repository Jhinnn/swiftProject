//
//  TicketSearchResultViewController.swift
//  WYP
//
//  Created by ShuYan Feng on 2017/5/16.
...
class TicketSearchResultViewController: BaseViewController {
    ...
    func clickSearchButton(sender: UIBarButtonItem) {
        ...
        let viewController = subViewControllers?[index] as! TicketsShowViewController
        viewController.typeId = "\(3 - index)"
...
extension TicketSearchResultViewController: UIScrollViewDelegate {
...
extension TicketSearchResultViewController: SYNavTabBarDelegate {
...
extension TicketSearchResultViewController: UITextFieldDelegate {
