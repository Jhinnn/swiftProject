...
class VoteViewController: BaseViewController {
    ...
    func layoutPageSubViews(){
        voteWebView.snp.makeConstraints { (make) in
...
//        messageObject.text = shareLink + ticketName
        // 分享对象
        let shareObject: UMShareWebpageObject = UMShareWebpageObject.shareObject(withTitle: ticketName, descr: "参与投票，有可能获得大奖哦，快来试试吧", thumImage: UIImage(named: "aladdiny_icon"))
        // 网址
    ...
    lazy var voteWebView: WKWebView = {
        // 自定义配置
...
extension VoteViewController: WKUIDelegate, WKNavigationDelegate {
...
extension VoteViewController: WKScriptMessageHandler {
