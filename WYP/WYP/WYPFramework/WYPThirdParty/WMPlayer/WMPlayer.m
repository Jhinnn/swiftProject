...
//    self.bottomView.backgroundColor = [UIColor colorWithWhite:0.4 alpha:0.4];
    ...
    [_shareBtn setImage:WMPlayerImage(@"common_share_button_ highlight_iPhone@2x") forState:UIControlStateNormal];
    //autoLayout _shareBtn
    [self.shareBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self.topView).with.offset(-8);
        make.height.mas_equalTo(30);
...
- (void)setURLString:(NSString *)URLString{
    ...
    if (self.closeBtnStyle==CloseBtnStylePop) {
        [_closeBtn setImage:WMPlayerImage(@"common_navback_button_ highlight_iPhone@2x.png") forState:UIControlStateNormal];
        [_closeBtn setImage:WMPlayerImage(@"common_navback_button_ highlight_iPhone@2x.png") forState:UIControlStateSelected];
